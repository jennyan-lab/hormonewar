...
questions = [
    ...
    {"q": "4. 연인과 의견 충돌이 생겼을 때 나는?", "opts": ["\"누가 맞고 틀렸는지보다 서로 어떤 마음이었는지 먼저 알고 싶어.\"", "\"감정도 중요하지만, 왜 그런 문제가 생겼는지부터 정리해보자.\""], "types": ["E", "T"]},
    {"q": "5. 연애할 때 내가 더 신경 쓰는 것은?", "opts": ["\"서로의 감정\"", "\"서로의 가치관\""], "types": ["E", "T"]},
    {"q": "6. 내가 연인에게 사랑받고 있다고 격하게 느끼는 순간은?", "opts": ["\"오늘 고생했어\", \"보고 싶다\" 같은 다정한 말을 해줄 때", "내가 가고 싶다던 곳을 기억해서 리드해 줄 때"], "types": ["E", "T"]},
    ...
    {"q": "14. 연애가 오래 지속되었을 때 내가 더 중요하게 생각하는 건?", "opts": ["서로 편안하고 안정적인 관계 유지, 일상 속 자연스러운 행복", "계속 설레고 새로운 자극이 있는 관계"], "types": ["S", "D"]}
]
